{
  ...
  <div x-data="{ showModal: true }">
    <button
      ...
      className="w-full px-4 py-2 text-sm text-white font-medium text-white bg-red-500 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-red-500"
    >
      {" "}
      Delete Sample Item{" "}
    </button>
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    ...
                    <span className="font-bold">Sample Item</span>? This action
                    cannot be undone.{" "}
                  </p>
                </div>
              </div>
